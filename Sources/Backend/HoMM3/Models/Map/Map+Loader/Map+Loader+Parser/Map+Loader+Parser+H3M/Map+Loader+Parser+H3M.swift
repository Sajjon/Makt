...
////        let bitmask = BitArray(data: rawBytes)
...
////        }
//
//        let rawBitMask = BitArray(BitArray(data: rawBytes).prefix(Spell.ID.allCases.count))
//        print(rawBitMask)
//        let availableSpellIDS = rawBitMask.enumerated().compactMap { (bitmaskIndex, available) -> Spell.ID? in
//            guard !available else { return nil }
//            let QaR = bitmaskIndex.quotientAndRemainder(dividingBy: 8)
//            let arrayIndex = QaR.quotient
//            let indexWithinInnerArray = QaR.remainder
//            let spellID: Spell.ID = spellBitLookup[arrayIndex][indexWithinInnerArray]
//            return spellID
//        }
//
//        //                let bitmask = BitArray(data: rawBytes)
